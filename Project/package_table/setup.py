...
setup(
  ...
  description='Visualisation of table modular multiplication',
  ...
  packages=['multiplication_table', 'multiplication_table.process_math', 'multiplication_table.process_vis'],
  zip_safe=False
)
